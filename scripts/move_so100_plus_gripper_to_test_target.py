"""手动将 SO-100 Plus 夹爪移动到不超过 10 度的测试目标。"""
...
def main() -> int:
    ...
    print("即将连接机械臂，并只让 gripper_joint 移动到测试目标。")
    try:
